import { defaultModelsDir, loadConfig, patchConfig } from "./disk-DHDludua.js";
import { i as hubUrl, r as getCatalogModel, t as CATALOG } from "./catalog-D9qvFKrt.js";
...
//#endregion
//#region src/lib/runtime/models.ts
...
function streamHubDownload(url, destPartial, startAt, onProgress, signal) {
	return new Promise((resolve, reject) => {
		const req = (url.startsWith("https:") ? https : http).get(url, { headers: {
...
//#endregion
export { models_exports as n, findReadyModel as t };
